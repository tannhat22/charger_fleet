...
#ifndef CHARGER_FLEET__SRC__DDS_UTILS__DDSSUBSCRIBEHANDLER_HPP
#define CHARGER_FLEET__SRC__DDS_UTILS__DDSSUBSCRIBEHANDLER_HPP
...
#endif // CHARGER_FLEET__SRC__DDS_UTILS__DDSSUBSCRIBEHANDLER_HPP
